...
class SoalController extends Controller
{
    ...
    {
        // Gunakan with('modul') supaya kita bisa ambil judul modul di tampilan tabel nanti
    ...
    {
        $request->validate([
            'modul_id'      => 'required|exists:moduls,id', // Tambahkan validasi ini
            'pertanyaan'    => 'required',
            'kategori'      => 'required',
            'fase'          => 'required',
            'pilihan_a'     => 'required',
        ...
        return redirect()->route('soal.index')->with('success', 'Soal berhasil ditambahkan dan dihubungkan ke modul!');
    }
    ...
    {
        $request->validate([
            'modul_id'      => 'required|exists:moduls,id', // Tambahkan validasi ini juga
            'pertanyaan'    => 'required',
            'kategori'      => 'required',
            'fase'          => 'required',
            'pilihan_a'     => 'required',
    ...
    {
        Soal::destroy($id);
        return redirect()->route('soal.index')->with('success', 'Soal berhasil dihapus selamanya! 🗑️');
    }

    // Menampilkan Leaderboard (Ranking)
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Ratusan soal berhasil mendarat dari Excel! 🚀');
    }
}