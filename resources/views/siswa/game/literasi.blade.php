...
<head>
    ...
    <title>Game Pengejar Huruf | Edulitnum</title>
    ...
    <style>
        body {
            ...
            margin: 0;
            overflow: hidden; /* Mengunci scrollbar agar gelembung melayang rapi */
            background-image: url('{{ asset("images/bg-arena-literasi.png") }}');
        ...
        /* Progress Bar Cairan Air Neon Biru */
        .bubble-progress {
            background: linear-gradient(to right, #38BDF8, #0284C7);
            box-shadow: 0 0 15px #38BDF8, inset 0 2px 4px rgba(255,255,255,0.4);
        ...
        .btn-jelly-3d {
            ...
            box-shadow: 0 6px 0 0 #0369A1, 0 10px 20px rgba(2, 132, 199, 0.2);
            transition: all 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275);
        }
        .btn-jelly-3d:hover {
            background: linear-gradient(to bottom, #E0F2FE, #BAE6FD);
            transform: translateY(-4px) scale(1.02); /* Melayang memantul naik sedikit */
            border-color: #2563EB;
...
<body class="min-h-screen flex flex-col justify-between relative select-none h-screen w-screen pb-6">
    ...
    <header class="w-full max-w-5xl mx-auto px-4 pt-4 relative z-10">
        <div class="glass-hud rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-white font-kids font-black text-lg tracking-wide uppercase">PENGEJAR HURUF</h1>
                    <p class="text-sky-300 text-xs font-bold">Misi: Jawab 15 Tantangan Literasi!</p>
                </div>
            </div>

            <div class="w-full md:w-1/2 bg-slate-900/80 rounded-full p-1 border border-white/10 relative overflow-hidden">
                <div id="timer-bar" class="bubble-progress h-5 rounded-full w-full"></div>
                <div class="absolute inset-0 flex items-center justify-center">
                    <span id="timer-text" class="text-white font-kids font-black text-xs tracking-widest drop-shadow-md">⏱️ 15:00</span>
                </div>
            </div>

            <div class="bg-sky-600 border-2 border-sky-400 px-5 py-1.5 rounded-xl shadow-[0_4px_0_0_#0369A1]">
    ...
    <footer class="w-full text-center text-white/50 font-fredoka font-bold text-[9px] uppercase tracking-widest relative z-10 pointer-events-none">
        🎮 PENGEJAR HURUF • PETUALANGAN EDULITNUM SEMESTER 4
    </footer>
    ...
    <script>
        ...
        // ==========================================================================
        // SCRIPT GENERATOR GELEMBUNG AIR MELAYANG
        // ==========================================================================
        ...
        function renderSoal() {
            ...
            document.getElementById('badge-kategori').innerText = soalSekarang.kategori ?? 'Literasi';
        ...
        function finishGame(isTimeUp) {
            // Formula Kompetitif: (Benar x 100) + Sisa Detik Waktu Kerja
            ...
            // Kirim data ke GameController via AJAX
            ...
            .then(data => {
                Swal.fire({
                    title: 'Selamat, Pujangga Cilik!',
                    html: `<div class="font-kids py-2">
                                <p class="text-base text-slate-600">Kamu berhasil menyelesaikan Misi Pengejar Huruf!</p>
                                <div class="text-5xl font-black text-sky-600 my-4 tracking-wide drop-shadow-sm">${skorAkhir}</div>
        ...
        window.onload = function() {
            createBubbles(); // Jalankan hujan gelembung air
            startTimer();    // Jalankan timer hitung mundur
            renderSoal();    // Muat soal pertama
        };
    </script>
</body>
</html>
