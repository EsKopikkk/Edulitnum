...
<body class="min-h-screen flex">
    ...
    <aside class="w-72 sidebar-glass fixed h-screen z-50 p-6 flex flex-col">
        ...
        <nav class="flex-1 space-y-2">
            <a href="#" class="flex items-center gap-4 px-4 py-4 bg-edu-orange text-white rounded-2xl font-bold shadow-lg shadow-edu-orange/30 transition-all">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                Dashboard
            </a>
            <a href="{{ route('admin.akun.index') }}" class="flex items-center gap-4 px-4 py-4 text-gray-500 hover:text-edu-blue hover:bg-white/50 rounded-2xl font-semibold transition-all group">
                <svg class="w-6 h-6 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                Manajemen User
            </a>
            <a href="#" class="flex items-center gap-4 px-4 py-4 text-gray-500 hover:text-edu-blue hover:bg-white/50 rounded-2xl font-semibold transition-all group">
    ...
    <main class="flex-1 ml-72 p-10">
        <header class="flex justify-between items-center mb-10">
            <div>
                <h1 class="text-3xl font-black text-edu-dark tracking-tighter">Halo, <span class="text-edu-orange">Admin!</span></h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            <div class="stat-card p-8 rounded-[32px] border border-white relative overflow-hidden group">
                <div class="absolute -right-4 -top-4 w-24 h-24 bg-edu-orange/5 rounded-full group-hover:scale-150 transition-transform duration-500"></div>
                ...
                <div class="mt-4 flex items-center gap-2 text-green-500 text-xs font-bold">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z"/></svg>
                    +12% Bulan ini
                </div>
            </div>

            <div class="stat-card p-8 rounded-[32px] border border-white relative overflow-hidden group">
                <div class="absolute -right-4 -top-4 w-24 h-24 bg-edu-blue/5 rounded-full group-hover:scale-150 transition-transform duration-500"></div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="text-sm font-semibold">
                    <tr class="border-b border-gray-50/50">
                        ...
                        <td class="py-5"><span class="px-3 py-1 bg-edu-blue/10 text-edu-blue rounded-full text-[10px]">SISWA</span></td>
                        <td class="py-5"><span class="w-2 h-2 rounded-full bg-green-500 inline-block mr-2"></span>Online</td>
                        <td class="py-5 text-right"><button class="px-4 py-2 bg-gray-100 hover:bg-edu-orange hover:text-white rounded-xl transition-all">Detail</button></td>
                    </tr>
                    </tbody>
            </table>
        </div>
