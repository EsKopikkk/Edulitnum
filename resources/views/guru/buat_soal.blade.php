            ...
            <div class="bg-white rounded-lg shadow p-6" style="border: 1px solid #FFC81E;">
                <form method="POST" action="{{ route('soal.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="pertanyaan" rows="4" class="w-full border rounded p-2" style="border-color: #FFC81E;" required></textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center mb-2 gap-2">
                            ...
                            <input type="text" name="pilihan_{{ strtolower($pilihan) }}" class="flex-1 border rounded p-2" style="border-color: #FFC81E;" placeholder="Isi pilihan {{ $pilihan }}" required>
                        </div>
                        @endforeach
                        <p class="text-sm text-gray-500 mt-1">* Pilih radio button untuk menandai kunci jawaban</p>
                    </div>
